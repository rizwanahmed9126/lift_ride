...
class HomeRide extends StatefulWidget{
  @override
  _HomeRideState createState() => _HomeRideState();
}
...
class _HomeRideState extends State<HomeRide> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer:FirstName == null ? Container(child: Center(child: CircularProgressIndicator()),):
      CustomDrawer(
        name: FirstName,
        email: email,
        title1: 'YourTrips',
            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                onTap: () async {
                  ...
                  pick=LatLng(24.872019018042295, 67.09101570848148);  //LatLng(24.882730092683023, 67.18224804740336);
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onTap: () async {
                    ...
                    drop=LatLng(24.878735102355893, 67.10599315214014);
            ...
            child: Positioned(
              ...
              child:Container(
                ...
                child:FlatButton(
                  ...
                  onPressed: (){
                    showSubmitWidget();
                    pick=LatLng(24.872019018042295, 67.09101570848148);
                    drop=LatLng(24.878735102355893, 67.10599315214014);
  ...
  setPolylines() async {
    ...
    setState(() {
      ...
      FindRideData.fareToShow=fare.toInt();
  ...
  void upload_trip_coord() async{
    ...
    DocumentReference docRef = await db.collection('PostedTrips').document();
    //below line get document id of main collection and save into variable
    documentid.id=docRef.documentID;
    docRef.collection('UserData').add({
      for(int i=0; i<polylineCoordinates.length;i++)
        'point$i': new GeoPoint(polylineCoordinates[i].latitude, polylineCoordinates[i].longitude),
